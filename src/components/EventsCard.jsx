...
import { Navigation as NavigationIcon, CalendarCheck, Phone, ExternalLink } from 'lucide-react'
      ...
      >
        ...
        <div className="space-y-3 text-gray-600">
          ...
          <div className="flex justify-center mt-2 pt-4">
            <motion.a
              href={
                eventData.title === "Wedding Ceremony"
                  ? "https://maps.app.goo.gl/fZz8vRAhjb7xzKUR6?g_st=iw"
                  : "https://maps.app.goo.gl/1QzQHNnbX61eQpqq7"
              } target="_blank"
